            ...
            <div className="text-center max-w-md p-4 bg-white rounded-lg shadow-sm">
              ...
              <div className="grid grid-cols-1 gap-3 text-sm">
                ...
                >
                  ...
                  <span className="line-clamp-2">"Is part W10295370A compatible with my Whirlpool refrigerator?"</span>
                </button>
                ...
                >
                  ...
                  <span className="line-clamp-2">"How do I install a water filter for model WRS325FDAM02?"</span>
                </button>
              </div>
            </div>
          </div>
